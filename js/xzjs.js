...
function loadNyroModal()
{
 ...
 var XZWebUrlWriter = {
    ...
    getWebIm_IframeUrl : function () {
        return webimIframUrl;
    },
    getWebIm_RequestLandlordDataUrl : function (roomid) {
        return 'http://'+domain+'/webim.php?op=getLandlordData&roomid=' + roomid;
    },
    getWebIm_RequestUserUrl : function (userid, roomid) {
        return 'http://'+domain+'/webim.php?op=getTenantData&userid=' + userid + '&roomid=' + roomid;
    },
    getWebIm_ParterUserUrl : function (str, id, source) {
        return 'http://'+domain+'/webim.php?op=getParterUserId&zhunaid='+id+'&zhunaname='+str+'&source='+source;
    },
    ...
    getWebIm_RequestUserIfLandlordUrl : function (userid) {
        return 'http://'+domain+'/webim.php?op=getIfLandlord&userid=' + userid;
    },
    getWebIm_InitLoadHistoryUserUrl : function (userid) {
        return 'http://'+domain+'/webim.php?op=getInitLoadHistoryUser&userid=' + userid;
    },
    getWebIm_LoadHistoryMessageUrl : function (thisuserid, userid, roomid) {
        return 'http://'+domain+'/webim.php?op=getLoadHistoryMessage&thisuserid='+thisuserid+'&userid=' + userid + '&roomid=' + roomid;
    },
    ...
    getWebIm_RequestIfRoomBelongUserUrl : function (userid, roomid) {
        return 'http://'+domain+'/webim.php?op=getIfRoomBelongUser&userid=' + userid + '&roomid=' + roomid;
    },
    ...
    getWebIm_MsgStatusUrl : function () {
        return 'http://'+domain+'/webim.php?op=setIsRead';
    },
    ...
    getWebIm_LoseMsgUrl : function (userid) {
        return 'http://'+domain+'/webim.php?op=setLoseMsg';
    },
    ...
    getWebIm_CheckKeyword : function (content) {
        return 'http://'+domain+'/webim.php?op=checkKeyword&content='+encodeURIComponent(content);
    },
    getWebIm_NeedOrderUrl : function (thisuserid, userid, roomid) {
        return 'http://'+domain+'/webim.php?op=getNeedOrder&selfid='+thisuserid+'&otherid='+userid+'&roomid='+roomid;
    },
    ...
    getWeb_FangKe_DoPostCommentUrl : function (objId,bookorderId,content,commentScore,luTag,fdTag,imageParam) {
        return 'http://'+domain+'/xzweb.php?op=FangKe_DoPostComment&objId=' + objId + '&bookorderId=' + bookorderId + '&content=' + content + commentScore + '&luTag=' + luTag + '&fdTag=' + fdTag + '&imageParam=' + imageParam;
    },
    ...
    getWeb_FangKe_AddCommentUrl : function (objId,bookorderId) {
        return 'http://'+domain+'/xzweb.php?op=FangKe_AddComment&objId=' + objId + '&bookorderId=' + bookorderId + '&random=' + new Date().getTime();
    },
    ...
    getFront_Register_SubmitUrl : function () {
        return 'http://'+domain+'/xzweb.php?op=Front_Register_Submit';
    },
    getFront_MailRegister_SubmitUrl : function () {
        return 'http://'+domain+'/xzweb.php?op=Front_Mail_Register_Submit';
    },
    ...
    getAjax_DelCommentUrl : function (commentId) {
        return 'http://'+domain+'/ajax.php?op=Ajax_DelComment&commentid='+commentId;
    },
    ...
    getAjax_CheckRegistExist : function (user) {
        return 'http://'+domain+'/ajax.php?op=AJAX_CheckRegistExist&user=' + user;
    },
    ...
    getAjax_SetAlipayInfoUrl : function (alipayno,alipayusername,balanceForm) {
        return 'http://'+domain+'/ajax.php?op=Ajax_SetAlipayInfo&alipayno='+alipayno+'&alipayusername='+alipayusername+'&balanceform='+balanceForm;
    },
    ...
    getAjax_GetLodgeUnitCalendar : function (lodgeUnitId, startdate, enddate) {
        return 'http://'+domain+'/ajax.php?op=Ajax_GetLodgeUnitCalendar&lodgeunitid='+lodgeUnitId+'&startdate='+startdate+'&enddate='+enddate+'&_t='+new Date().getTime();
    },
    ...
    getAjax_Pub_CreateIntro : function () {
        return 'http://'+domain+'/ajax.php?op=Ajax_Pub_CreateIntro';
    },
    ...
    getPub_Step1_AutoSave : function(){
        return 'http://'+domain+'/ajax.php?op=Pub_HouseDetail_AutoSave';
    },
    getPub_Step2_AutoSave : function(){
        return 'http://'+domain+'/ajax.php?op=Pub_RoomDetail_AutoSave';
    },
    getPub_Step3_AutoSave : function(){
        return 'http://'+domain+'/ajax.php?op=Pub_RoomFacilities_AutoSave';
    },
    getPub_Step4_AutoSave : function(){
        return 'http://'+domain+'/ajax.php?op=Pub_RoomPicture_AutoSave';
    },
    getPub_Step5_AutoSave : function(){
        return 'http://'+domain+'/ajax.php?op=Pub_RoomPrice_AutoSave&rand='+Math.random();
    },
    ...
    getAjax_FD_Pub_Diary_SubmitUrl : function () {
        return 'http://'+domain+'/ajax.php?op=FD_Pub_Diary_Submit';
    },
    ...
    getAJAX_GetLodgeUnitCalendar : function (luid,startDate,endDate,editable){
        return 'http://'+domain+'/ajax.php?op=AJAX_GetLodgeUnitCalendar&lodgeunitid='+luid+'&startdate='+startDate+'&enddate='+endDate+'&editable='+editable+'&rand='+Math.random();
    }
    
};
 
 var xzRegularExpression={a:1,isNum:/^\d{1,}$/,isMobile:/^\d{11}$/,isUsername:/^[\w|\u4E00-\u9FA5]*$/,simpleMobile:/^\d{11}$/,mobile:/^1((3[0-9])|(4[57])|(5[0-35-9])|(7[6780])|(8[0-9]))\d{8}$/,password:/^[0-9a-zA-Z*!@.\-? : ;|$#%^&()_+=\[\]\\\/{}<>",~`']{0,}$/,numbers:/[1-9][0-9]{4}/,simpleEmail:/^.*?@.+$/,email:/^[a-zA-Z0-9_\.\-]+@[a-zA-Z0-9_\-]+(\.[a-zA-Z0-9_\-]+)+[a-zA-Z]+$/,passport:/^[\d\w]{4,20}$/}; 
 (function($) {
...
hotcitys[0]=new Array('bj','北京','beijing','bj','2625','beijing','北京','','',12);

hotcitys[1]=new Array('sh','上海','shanghai','sh','1419','shanghai','上海','','',13);

hotcitys[2]=new Array('gz','广州','guangzhou','gz','592','guangdong','广东','','',16);

hotcitys[3]=new Array('cd','成都','chengdu','cd','1085','sichuan','四川','','',45);

hotcitys[4]=new Array('sz','深圳','shenzhen','sz','391','guangdong','广东','','',17);

hotcitys[5]=new Array('xa','西安','xian','xa','671','shanxi','陕西','','',176);

hotcitys[6]=new Array('nj','南京','nanjing','nj','305','jiangsu','江苏','','',65);

hotcitys[7]=new Array('hz','杭州','hangzhou','hz','404','zhejiang','浙江','','',26);

hotcitys[8]=new Array('cq','重庆','chongqing','cq','662','zhongqing','重庆','','',15);

hotcitys[9]=new Array('wh','武汉','wuhan','wh','302','hubei','湖北','','',194);

hotcitys[10]=new Array('sz','苏州','suzhou','su','247','jiangsu','江苏','','',67);

hotcitys[11]=new Array('wx','无锡','wuxi','wx','70','jiangsu','江苏','','',66);

hotcitys[12]=new Array('qd','青岛','qingdao','qd','1479','shandong','山东','','',114);

hotcitys[13]=new Array('xm','厦门','xiamen','xm','405','fujian','福建','','',76);

hotcitys[14]=new Array('sy','三亚','sanya','sanya','905','hainan','海南','','',144);

hotcitys[15]=new Array('dl','大连','dalian','dl','492','liaoning','辽宁','','',56);

hotcitys[16]=new Array('km','昆明','kunming','km','142','yunnan','云南','','',225);

hotcitys[17]=new Array('xg','香港','xianggang','xianggang','204','xianggang','香港','','',344);

hotcitys[18]=new Array('sy','沈阳','shenyang','sy','179','liaoning','辽宁','','',55);

hotcitys[19]=new Array('zz','郑州','zhengzhou','zz','307','henan','河南','','',103);

var citys=new Array();

citys[0]=new Array('bj','北京','beijing','bj','2625','beijing','北京','','',12);

citys[1]=new Array('sh','上海','shanghai','sh','1419','shanghai','上海','','',13);

citys[2]=new Array('gz','广州','guangzhou','gz','592','guangdong','广东','','',16);

citys[3]=new Array('cd','成都','chengdu','cd','1085','sichuan','四川','','',45);

citys[4]=new Array('sz','深圳','shenzhen','sz','391','guangdong','广东','','',17);

citys[5]=new Array('xa','西安','xian','xa','671','shanxi','陕西','','',176);

citys[6]=new Array('nj','南京','nanjing','nj','305','jiangsu','江苏','','',65);

citys[7]=new Array('hz','杭州','hangzhou','hz','404','zhejiang','浙江','','',26);

citys[8]=new Array('cq','重庆','chongqing','cq','662','zhongqing','重庆','','',15);

citys[9]=new Array('wh','武汉','wuhan','wh','302','hubei','湖北','','',194);

citys[10]=new Array('sz','苏州','suzhou','su','247','jiangsu','江苏','','',67);

citys[11]=new Array('wx','无锡','wuxi','wx','70','jiangsu','江苏','','',66);

citys[12]=new Array('qd','青岛','qingdao','qd','1479','shandong','山东','','',114);

citys[13]=new Array('xm','厦门','xiamen','xm','405','fujian','福建','','',76);

citys[14]=new Array('sy','三亚','sanya','sanya','905','hainan','海南','','',144);

citys[15]=new Array('dl','大连','dalian','dl','492','liaoning','辽宁','','',56);

citys[16]=new Array('heb','哈尔滨','haerbin','hrb','200','heilongjiang','黑龙江','','',93);

citys[17]=new Array('qhd','秦皇岛','qinhuangdao','qinhuangdao','646','hebei','河北','','',3);

citys[18]=new Array('tj','天津','tianjin','tj','141','tianjin','天津','','',14);

citys[19]=new Array('km','昆明','kunming','km','142','yunnan','云南','','',225);

citys[20]=new Array('xg','香港','xianggang','xianggang','204','xianggang','香港','','',344);

citys[21]=new Array('cc','长春','changchun','cc','84','jilin','吉林','','',84);

citys[22]=new Array('sy','沈阳','shenyang','sy','179','liaoning','辽宁','','',55);

citys[23]=new Array('hf','合肥','hefei','hf','116','anhui','安徽','','',123);

citys[24]=new Array('zz','郑州','zhengzhou','zz','307','henan','河南','','',103);

citys[25]=new Array('ty','太原','taiyuan','ty','74','shanxi','山西','','',155);

citys[26]=new Array('wh','威海','weihai','wei','281','shandong','山东','','',120);

citys[27]=new Array('lj','丽江','lijiang','lijiang','65','yunnan','云南','','',230);

citys[28]=new Array('dl','大理','dali','dali','65','yunnan','云南','','',237);

citys[29]=new Array('gl','桂林','guilin','gl','118','guangxi','广西','','',134);

citys[30]=new Array('fz','福州','fuzhou','fz','50','fujian','福建','','',75);

citys[31]=new Array('nb','宁波','ningbo','nb','21','zhejiang','浙江','','',27);

citys[32]=new Array('zh','珠海','zhuhai','zhuhai','76','guangdong','广东','','',18);

citys[33]=new Array('cs','长沙','changsha','cs','198','hunan','湖南','','',204);

citys[34]=new Array('sjz','石家庄','shijiazhuang','sjz','144','hebei','河北','','',1);

citys[35]=new Array('ls','拉萨','lasa','ls','10','xicang','西藏','','',256);

citys[36]=new Array('bh','北海','beihai','beihai','118','guangxi','广西','','',317);

citys[37]=new Array('yt','烟台','yantai','yantai','254','shandong','山东','','',118);

citys[38]=new Array('dg','东莞','dongguan','dg','8','guangdong','广东','','',24);

citys[39]=new Array('hk','海口','haikou','hn','83','hainan','海南','','',143);

citys[40]=new Array('lz','兰州','lanzhou','lz','83','gansu','甘肃','','',166);

citys[41]=new Array('ly','洛阳','luoyang','luoyang','46','henan','河南','','',104);

citys[42]=new Array('wlmq','乌鲁木齐','wulumuqi','xj','22','xinjiang','新疆','','',241);

citys[43]=new Array('xz','徐州','xuzhou','xuzhou','19','jiangsu','江苏','','',68);

citys[44]=new Array('gy','贵阳','guiyang','gy','64','guizhou','贵州','','',36);

citys[45]=new Array('hhht','呼和浩特','huhehaote','nmg','40','neimenggu','内蒙古','','',145);

citys[46]=new Array('jn','济南','jinan','jn','203','shandong','山东','','',113);

citys[47]=new Array('ts','唐山','tangshan','tangshan','20','hebei','河北','','',2);

citys[48]=new Array('bd','保定','baoding','baoding','21','hebei','河北','','',6);

citys[49]=new Array('nc','南昌','nanchang','nc','22','jiangxi','江西','','',214);

citys[50]=new Array('hd','邯郸','handan','handan','6','hebei','河北','','',4);

citys[51]=new Array('nn','南宁','nanning','nn','20','guangxi','广西','','',142);

citys[52]=new Array('wf','潍坊','weifang','weifang','10','shandong','山东','','',119);

citys[53]=new Array('jz','锦州','jinzhou','jinzhou','8','liaoning','辽宁','','',60);

citys[54]=new Array('rz','日照','rizhao','rizhao','311','shandong','山东','','',306);

citys[55]=new Array('ly','临沂','linyi','linyi','17','shandong','山东','','',307);

citys[56]=new Array('as','鞍山','anshan','anshan','13','liaoning','辽宁','','',57);

citys[57]=new Array('lf','廊坊','langfang','langfang','12','hebei','河北','','',10);

citys[58]=new Array('dq','大庆','daqing','daqing','2','heilongjiang','黑龙江','','',98);

citys[59]=new Array('cz','常州','changzhou','changzhou','19','jiangsu','江苏','','',69);

citys[60]=new Array('zs','中山','zhongshan','zhongshan','26','guangdong','广东','','',25);

citys[61]=new Array('xn','西宁','xining','xn','71','qinghai','青海','','',186);

citys[62]=new Array('jh','金华','jinhua','jinhua','11','zhejiang','浙江','','',32);

citys[63]=new Array('dd','丹东','dandong','dandong','44','liaoning','辽宁','','',59);

citys[64]=new Array('cd','承德','chengde','chengde','138','hebei','河北','','',8);

citys[65]=new Array('pj','盘锦','panjin','panjin','19','liaoning','辽宁','','',63);

citys[66]=new Array('zb','淄博','zibo','zibo','7','shandong','山东','','',115);

citys[67]=new Array('zz','株洲','zhuzhou','zhuzhou','14','hunan','湖南','','',205);

citys[68]=new Array('fs','佛山','foshan','foshan','18','guangdong','广东','','',20);

citys[69]=new Array('jl','吉林','jilinshi','jilin','9','jilin','吉林','','',85);

citys[70]=new Array('xt','邢台','xingtai','xingtai','1','hebei','河北','','',5);
...
citys[73]=new Array('dt','大同','datong','datong','46','shanxi','山西','','',156);

citys[74]=new Array('yz','扬州','yangzhou','yangzhou','31','jiangsu','江苏','','',74);

citys[75]=new Array('yc','银川','yinchuan','yc','28','ningxia','宁夏','','',165);

citys[76]=new Array('wz','温州','wenzhou','wenzhou','20','zhejiang','浙江','','',28);

citys[77]=new Array('ha','淮安','huaian','huaian','10','jiangsu','江苏','','',72);

citys[78]=new Array('my','绵阳','mianyang','mianyang','37','sichuan','四川','','',49);

citys[79]=new Array('bt','包头','baotou','baotou','10','neimenggu','内蒙古','','',146);

citys[80]=new Array('fs','抚顺','fushun','fushun','15','liaoning','辽宁','','',58);

citys[81]=new Array('ta','泰安','taian','taian','25','shandong','山东','','',305);

citys[82]=new Array('jn','济宁','jining','jining','12','shandong','山东','','',304);

citys[83]=new Array('lyg','连云港','lianyungang','lianyungang','6','jiangsu','江苏','','',71);

citys[84]=new Array('qz','泉州','quanzhou','quanzhou','7','fujian','福建','','',79);

citys[85]=new Array('ay','安阳','anyang','anyang','4','henan','河南','','',109);

citys[86]=new Array('hz','惠州','huizhou','huizhou','47','guangdong','广东','','',23);

citys[87]=new Array('hld','葫芦岛','huludao','huludao','143','liaoning','辽宁','','',64);

citys[88]=new Array('jx','嘉兴','jiaxing','jiaxing','68','zhejiang','浙江','','',29);

citys[89]=new Array('nt','南通','nantong','nantong','8','jiangsu','江苏','','',70);

citys[90]=new Array('jms','佳木斯','jiamusi','jiamusi','9','heilongjiang','黑龙江','','',100);

citys[91]=new Array('dz','德州','dezhou','dezhou','2','shandong','山东','','',308);

citys[92]=new Array('gz','赣州','ganzhou','ganzhou','1','jiangxi','江西','','',220);

citys[93]=new Array('xy','咸阳','xianyang','xianyang','2','shanxi','陕西','','',179);

citys[94]=new Array('zz','漳州','zhangzhou','zhangzhou','11','fujian','福建','','',80);

citys[95]=new Array('xx','新乡','xinxiang','xinxiang','2','henan','河南','','',108);

citys[96]=new Array('xf','襄樊','xiangfan','xiangfan','1','hubei','湖北','','',196);

citys[97]=new Array('nc','南充','nanchong','nanchong','4','sichuan','四川','','',51);

citys[98]=new Array('lc','聊城','liaocheng','liaocheng','1','shandong','山东','','',309);

citys[99]=new Array('zjk','张家口','zhangjiakou','zhangjiakou','27','hebei','河北','','',7);

citys[100]=new Array('cz','沧州','cangzhou','cangzhou','1','hebei','河北','','',9);

citys[101]=new Array('shz','石河子','shihezi','shihezi','1','xinjiang','新疆','','',255);

citys[102]=new Array('bj','宝鸡','baoji','baoji','2','shanxi','陕西','','',178);

citys[103]=new Array('cf','赤峰','chifeng','chifeng','1','neimenggu','内蒙古','','',148);

citys[104]=new Array('zj','湛江','zhanjiang','zhanjiang','5','guangdong','广东','','',264);

citys[105]=new Array('sq','商丘','shangqiu','shangqiu','3','henan','河南','','',297);

citys[106]=new Array('pds','平顶山','pingdingshan','pingdingshan','1','henan','河南','','',105);

citys[107]=new Array('jj','九江','jiujiang','jiujiang','9','jiangxi','江西','','',217);

citys[108]=new Array('yk','营口','yingkou','yingkou','170','liaoning','辽宁','','',61);

citys[109]=new Array('st','汕头','shantou','shantou','3','guangdong','广东','','',19);

citys[110]=new Array('wh','芜湖','wuhu','wuhu','5','anhui','安徽','','',124);

citys[111]=new Array('hlbe','呼伦贝尔','hulunbeier','hulunbeier','69','neimenggu','内蒙古','','',151);

citys[112]=new Array('xt','湘潭','xiangtan','xiangtan','2','hunan','湖南','','',206);

citys[113]=new Array('cys','朝阳市','chaoyang','chaoyang','1','liaoning','辽宁','','',289);

citys[114]=new Array('qy','清远','qingyuan','qingyuan','11','guangdong','广东','','',270);

citys[115]=new Array('sn','遂宁','suining','suining','1','sichuan','四川','','',276);

citys[116]=new Array('tz','泰州','jstaizhou','jstaizhou','1','jiangsu','江苏','','',291);

citys[117]=new Array('lz','泸州','luzhou','luzhou','15','sichuan','四川','','',47);

citys[118]=new Array('zs','舟山','zhoushan','zhoushan','25','zhejiang','浙江','','',34);

citys[119]=new Array('zj','镇江','zhenjiang','zhenjiang','2','jiangsu','江苏','','',290);

citys[120]=new Array('kf','开封','kaifeng','kaifeng','8','henan','河南','','',293);

citys[121]=new Array('eeds','鄂尔多斯','eerduosi','eerduosi','1','neimenggu','内蒙古','','',150);

citys[122]=new Array('yb','延边','yanbian','yanbian','11','jilin','吉林','','',92);

citys[123]=new Array('lf','临汾','linfen','linfen','3','shanxi','山西','','',164);

citys[124]=new Array('cd','常德','changde','changde','2','hunan','湖南','','',210);

citys[125]=new Array('cz','郴州','chenzhou','chenzhou','1','hunan','湖南','','',211);

citys[126]=new Array('sx','绍兴','shaoxing','shaoxing','14','zhejiang','浙江','','',31);

citys[127]=new Array('ny','南阳','nanyang','nanyang','2','henan','河南','','',111);

citys[128]=new Array('hz','菏泽','heze','heze','2','shandong','山东','','',338);

citys[129]=new Array('tz','台州','zjtaizhou','zjtaizhou','1','zhejiang','浙江','','',35);

citys[130]=new Array('zy','遵义','zunyi','zunyi','7','guizhou','贵州','','',38);

citys[131]=new Array('xq','宿迁','suqian','suqian','1','jiangsu','江苏','','',292);

citys[132]=new Array('jz','焦作','jiaozuo','jiaozuo','6','henan','河南','','',106);

citys[133]=new Array('cz','长治','changzhi','changzhi','11','shanxi','山西','','',158);

citys[134]=new Array('ja','吉安','jian','jian','2','jiangxi','江西','','',221);

citys[135]=new Array('hz','汉中','hanzhong','hanzhong','1','shanxi','陕西','','',182);

citys[136]=new Array('tl','铁岭','tieling','tieling','1','liaoning','辽宁','','',288);

citys[137]=new Array('jz','晋中','jinzhong','jinzhong','26','shanxi','山西','','',161);

citys[138]=new Array('ak','安康','ankang','ankang','1','shanxi','陕西','','',184);

citys[139]=new Array('yy','岳阳','yueyang','yueyang','1','hunan','湖南','','',209);

citys[140]=new Array('zq','肇庆','zhaoqing','zhaoqing','2','guangdong','广东','','',265);

citys[141]=new Array('hs','衡水','hengshui','hengshui','4','hebei','河北','','',11);

citys[142]=new Array('mdj','牡丹江','mudanjiang','mudanjiang','3','heilongjiang','黑龙江','','',302);

citys[143]=new Array('ls','乐山','leshan','leshan','30','sichuan','四川','','',50);

citys[144]=new Array('bb','蚌埠','bengbu','bengbu','2','anhui','安徽','','',125);

citys[145]=new Array('sg','韶关','shaoguan','shaoguan','7','guangdong','广东','','',263);

citys[146]=new Array('yj','阳江','yangjiang','yangjiang','1','guangdong','广东','','',269);

citys[147]=new Array('cz','潮州','chaozhou','chaozhou','2','guangdong','广东','','',271);

citys[148]=new Array('zjj','张家界','zhangjiajie','zhangjiajie','14','hunan','湖南','','',334);

citys[149]=new Array('xsbn','西双版纳','xishuangbanna','xishuangbanna','8','yunnan','云南','','',235);

citys[150]=new Array('sm','三明','sanming','sanming','1','fujian','福建','','',78);

citys[151]=new Array('ms','眉山','meishan','meishan','1','sichuan','四川','','',279);

citys[152]=new Array('fcg','防城港','fangchenggang','fangchenggang','3','guangxi','广西','','',318);

citys[153]=new Array('yy','益阳','yiyang','yiyang','1','hunan','湖南','','',335);

citys[154]=new Array('sr','上饶','shangrao','shangrao','3','jiangxi','江西','','',224);

citys[155]=new Array('qz','衢州','quzhou','quzhou','2','zhejiang','浙江','','',33);

citys[156]=new Array('lps','六盘水','liupanshui','liupanshui','1','guizhou','贵州','','',37);

citys[157]=new Array('bs','白山','baishan','baishan','6','jilin','吉林','','',89);

citys[158]=new Array('sz','池州','chizhou','chizhou','1','anhui','安徽','','',315);

citys[159]=new Array('hs','黄石','huangshi','huangshi','6','hubei','湖北','','',195);

citys[160]=new Array('xx','湘西','xiangxi','xiangxi','5','hunan','湖南','','',337);

citys[161]=new Array('yc','宜春','jxyichun','jxyichun','1','jiangxi','江西','','',222);

citys[162]=new Array('ls','凉山','liangshan','liangshan','8','sichuan','四川','','',54);

citys[163]=new Array('yb','宜宾','yibin','yibin','8','sichuan','四川','','',52);

citys[164]=new Array('hz','湖州','huzhou','huzhou','25','zhejiang','浙江','','',30);

citys[165]=new Array('cz','滁州','chuzhou','chuzhou','1','anhui','安徽','','',128);

citys[166]=new Array('ya','延安','yanan','yanan','5','shanxi','陕西','','',181);

citys[167]=new Array('np','南平','nanping','nanping','1','fujian','福建','','',81);

citys[168]=new Array('sy','松原','songyuan','songyuan','4','jilin','吉林','','',90);

citys[169]=new Array('hs','黄山','huangshan','huangshan','16','anhui','安徽','','',313);

citys[170]=new Array('byne','巴彦淖尔','bayannaoer','bayannaoer','1','neimenggu','内蒙古','','',152);

citys[171]=new Array('wn','渭南','weinan','weinan','1','shanxi','陕西','','',180);

citys[172]=new Array('xn','咸宁','xianning','xianning','3','hubei','湖北','','',329);

citys[173]=new Array('es','恩施','enshi','enshi','6','hubei','湖北','','',331);

citys[174]=new Array('ly','龙岩','longyan','longyan','7','fujian','福建','','',82);

citys[175]=new Array('th','通化','tonghua','tonghua','5','jilin','吉林','','',88);

citys[176]=new Array('xlgl','锡林郭勒','xilinguole','xilinguole','1','neimenggu','内蒙古','','',321);

citys[177]=new Array('jdz','景德镇','jingdezhen','jingdezhen','1','jiangxi','江西','','',215);

citys[178]=new Array('hh','黑河','heihe','heihe','3','heilongjiang','黑龙江','','',101);

citys[179]=new Array('ll','吕梁','lvliang','lvliang','6','shanxi','山西','','',323);

citys[180]=new Array('yl','榆林','sxyulin','sxyulin','4','shanxi','陕西','','',183);

citys[181]=new Array('px','萍乡','pingxiang','pingxiang','2','jiangxi','江西','','',216);

citys[182]=new Array('hm','哈密','hami','hami','6','xinjiang','新疆','','',244);

citys[183]=new Array('ab','阿坝','aba','aba','7','sichuan','四川','','',283);

citys[184]=new Array('nd','宁德','ningde','ningde','5','fujian','福建','','',83);

citys[185]=new Array('als','阿拉善','alashan','alashan','9','neimenggu','内蒙古','','',322);

citys[186]=new Array('yq','阳泉','yangquan','yangquan','2','shanxi','山西','','',157);

citys[187]=new Array('ks','喀什','kashi','kashi','1','xinjiang','新疆','','',247);

citys[188]=new Array('yc','伊春','hljyichun','hljyichun','9','heilongjiang','黑龙江','','',99);

citys[189]=new Array('aks','阿克苏','akesu','akesu','1','xinjiang','新疆','','',246);

citys[190]=new Array('ga','广安','guangan','guangan','1','sichuan','四川','','',278);

citys[191]=new Array('qdn','黔东南','qiandongnan','qiandongnan','2','guizhou','贵州','','',43);

citys[192]=new Array('zy','张掖','zhangye','zhangye','6','gansu','甘肃','','',171);

citys[193]=new Array('jq','酒泉','jiuquan','jiuquan','5','gansu','甘肃','','',173);

citys[194]=new Array('snj','神农架','shennongjia','shennongjia','5','hubei','湖北','','',333);

citys[195]=new Array('klmy','克拉玛依','kelamayi','kelamayi','1','xinjiang','新疆','','',242);

citys[196]=new Array('yl','伊犁','yili','yili','4','xinjiang','新疆','','',252);

citys[197]=new Array('gz','甘孜','ganzi','ganzi','2','sichuan','四川','','',284);

citys[198]=new Array('ls','丽水','lishui','lishui','2','zhejiang','浙江','','',285);

citys[199]=new Array('wys','武夷山','wuyishan','wuyishan','1','fujian','福建','','',349);

citys[200]=new Array('hz','贺州','hezhou','hezhou','2','guangxi','广西','','',319);

citys[201]=new Array('tc','铜川','tongchuan','tongchuan','2','shanxi','陕西','','',177);

citys[202]=new Array('xz','忻州','xinzhou','xinzhou','4','shanxi','山西','','',163);

citys[203]=new Array('ww','武威','wuwei','wuwei','1','gansu','甘肃','','',170);

citys[204]=new Array('hx','海西','haixi','haixi','1','qinghai','青海','','',193);

citys[205]=new Array('hh','红河','honghe','honghe','1','yunnan','云南','','',234);

citys[206]=new Array('jyg','嘉峪关','jiayuguan','jiayuguan','2','gansu','甘肃','','',343);

citys[207]=new Array('hb','海北','haibei','haibei','1','qinghai','青海','','',188);

citys[208]=new Array('bs','保山','baoshan','baoshan','1','yunnan','云南','','',228);

citys[209]=new Array('dq','迪庆','diqing','diqing','1','yunnan','云南','','',240);

citys[210]=new Array('wc','文昌','wenchang','wc','4','hainan','海南','','',397);

citys[211]=new Array('qh','琼海','qionghai','qionghai','1','hainan','海南','','',399);

citys[212]=new Array('wn','万宁','wanning','wanning','3','hainan','海南','','',401);

citys[213]=new Array('ld','乐东','ledong','ledong','1','hainan','海南','','',409);

citys[214]=new Array('ls','陵水','lingshui','lingshui','5','hainan','海南','','',410);

citys[215]=new Array('changbaish','长白山','changbaishan','changbaishan','7','jilin','吉林','','',413);

citys[216]=new Array('tb','台北','taibei','tb','5','taiwan','台湾','','',378);

citys[217]=new Array('xb','新北','xinbei','xb','6','taiwan','台湾','','',379);

citys[218]=new Array('tz','台中','taizhong','tz','3','taiwan','台湾','','',380);

citys[219]=new Array('gx','高雄','gaoxiong','gx','2','taiwan','台湾','','',382);

citys[220]=new Array('jy','嘉义','jiayi','jy','1','taiwan','台湾','','',385);
